      ...
      <div class="contact-text">
        ...
        <div style="float: left; margin-top: 10%; margin-left: 20%; ">
          ...
          <div class="field2" id="sign">
            ...
            <br/>
            <input type="text" id="name" role="textbox" placeholder="예악자 이름을 입력해주세요" name="name" v-model="name" /><br/><br/>
          ...
          <div style="position: relative; left: 125px; top: 30px">
            ...
            <input type="submit" id="addallow" value="결제하기" >
          </div>
        </div>
      </div>
    </div>
...
body, h2, p, div, strong, span, input, a {
  text-align: left;
}
