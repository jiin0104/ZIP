        ...
        <div class="contact-form-area equal-height container" style="padding-top: 6%; max-width: 465px;">
          <div class="contact-text">
            ...
            <div class="field2" id="sign">
              ...
              <input type="button" id="crosscheck" value="중복 확인" @click="validateEmail">
              <br /><br />
            </div>
            ...
            <div class="field2" id="sign">
              ...
              <input type="text" id="nickname" role="textbox" placeholder="닉네임을 입력해 주세요." name="nickname"
                v-model="nickname" />
              <input type="button" id="crosscheck" value="중복 확인" @click="validateNickname"><br /><br />
            </div>
            ...
            <div class="field2">
              ...
              <input type="text" placeholder="주소" role="textbox" v-model="roadAddress" readonly style="width: 67%;" /><br />
